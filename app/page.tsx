...
function generateScript(userPrompt: string): Array<{ name: string; text: string; imagePrompt: string }> {
  ...
  return [
    ...
    { name: 'Wanderer', text: `The path before you is not what it seems. ${theme} has many secrets hidden in shadow and light.`, imagePrompt: `enigmatic wanderer on rocky path, ${theme} landscape, moody lighting, consistent dark cinematic theme` },
